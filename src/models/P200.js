...
module.exports = class P200 extends Camera {
    constructor({ host, version, debug = false }) {
        super({ host, debug });
        this.version = version; // for special cases between hardware versions of the P200
    }
    ...
    // catch the standard camera family calls that have special cases for the P200 and let everything else
