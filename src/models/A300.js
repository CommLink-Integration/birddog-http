...
module.exports = class A300 extends Camera {
    constructor({ host, version, debug = false }) {
        super({ host, debug });
        this.version = version; // for special cases between hardware versions of the A300
    }
    ...
    // catch the standard camera family calls that have special cases for the A300 and let everything else
